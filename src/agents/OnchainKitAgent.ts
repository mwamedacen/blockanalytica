...
//     config: z.any().describe('Optional configuration for the component depending on the intent, for swap it will be the from and to token address and token name, amount, etc.'),
